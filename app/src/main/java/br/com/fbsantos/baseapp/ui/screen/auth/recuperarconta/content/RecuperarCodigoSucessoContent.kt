...
fun RecuperarCodigoSucessoContent(navController: NavController) {
    AuthContainer {
        ...
        Text(
            text = "Agora é só voltar e fazer login com seu usuário e senha. Boa sorte nessa nova jornada!",
        ...
        Button(
            onClick = { NavHelper.abrir(navController, Routes.Login.route, Routes.RecuperarConta.route) },
